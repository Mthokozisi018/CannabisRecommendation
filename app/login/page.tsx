      ...
      <section className="relative w-full max-w-[640px] rounded-[24px] border border-white/28 bg-[linear-gradient(145deg,rgba(32,42,39,0.84),rgba(7,12,13,0.9)_48%,rgba(10,16,16,0.96))] px-5 py-8 shadow-[0_34px_96px_rgba(0,0,0,0.58),inset_0_1px_0_rgba(255,255,255,0.1)] backdrop-blur-2xl sm:px-9 md:px-12 md:py-10">
        ...
        <div className="relative">
          ...
          <div className="mx-auto mt-9 max-w-[520px]">
            ...
            <Link href="/forgot-account" className="mx-auto mt-1 flex w-fit items-center gap-3 rounded-lg px-3 py-2 text-sm font-semibold text-white/72 transition hover:bg-white/8 hover:text-white">
              Forgot Customer Account Details?
            </Link>
            <Link href="/customer/register" className="mx-auto mt-2 flex h-12 w-full max-w-sm items-center justify-center gap-3 rounded-xl border-2 border-[#70d84d] bg-[#70d84d]/10 px-4 text-base font-extrabold text-[#8ef46b] transition hover:bg-[#70d84d]/20">
