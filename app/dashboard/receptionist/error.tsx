...
export default function ReceptionistDashboardError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <main className="grid min-h-screen place-items-center bg-[#071008] px-4 text-white">
      <section className="max-w-lg rounded-2xl border-2 border-red-400 bg-[#180b0b] p-8 text-center">
        <h1 className="text-2xl font-black">Receptionist workstation is unavailable</h1>
        <p className="mt-3 text-white/70">The workstation could not be loaded safely. Your cart was not submitted.</p>
