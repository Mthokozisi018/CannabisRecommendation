...
export function ProductGrid({
  ...
  return (
    <div className="gc-pos-product-grid grid grid-cols-2 items-stretch gap-3 sm:grid-cols-[repeat(2,minmax(240px,300px))] lg:grid-cols-[repeat(3,minmax(240px,300px))]">
