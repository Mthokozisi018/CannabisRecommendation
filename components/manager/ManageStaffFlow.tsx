        ...
        <section className="mx-auto mt-3 max-w-[760px] rounded-xl border border-[#6fbd3f] bg-[#050b07] p-4 text-left shadow-[0_14px_42px_rgba(0,0,0,0.38)] sm:p-5">
          ...
          <form action={formAction} className="mt-4 grid gap-3">
            ...
            <label className="text-xs font-bold text-white">
              ...
              <span className="mt-1.5 flex h-12 items-center gap-3 rounded-lg border border-[#6fbd3f] bg-[#020604] px-3 text-white/75 focus-within:border-lime-300">
                <LockKeyhole size={18} />
                <input required name="password" type={showPassword ? "text" : "password"} autoComplete="new-password" maxLength={256} className="min-w-0 flex-1 bg-transparent text-sm text-white outline-none" />
            ...
            <label className="text-xs font-bold text-white">
              ...
              <span className="mt-1.5 flex h-12 items-center gap-3 rounded-lg border border-[#6fbd3f] bg-[#020604] px-3 text-white/75 focus-within:border-lime-300">
                <LockKeyhole size={18} />
                <input required name="confirmPassword" type={showConfirmPassword ? "text" : "password"} autoComplete="new-password" maxLength={256} className="min-w-0 flex-1 bg-transparent text-sm text-white outline-none" />
            ...
            <p className="rounded-lg border border-[#497d2c] bg-[#09120c] px-3 py-2.5 text-xs leading-5 text-white/85">Choose any non-empty temporary password. No uppercase, lowercase, number, or symbol requirements apply.</p>
